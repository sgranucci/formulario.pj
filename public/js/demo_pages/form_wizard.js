    ...
    var _componentWizard = function() {
        ...
        $('.steps-basic').steps({
            ...
            labels: {
                ...
                finish: 'Finalizar Carga <i class="icon-arrow-right14 ml-2" />'
            },
        ...
        $('.steps-validation').steps({
            ...
            labels: {
                previous: '<i class="icon-arrow-left13 mr-2" /> Anterior',
                next: 'Siguiente <i class="icon-arrow-right14 ml-2" />',
                finish: 'Enviar form <i class="icon-arrow-right14 ml-2" />'
            },
            transitionEffect: 'fade',
            autoFocus: true,
            onStepChanging: function (event, currentIndex, newIndex) {
                ...
                if ((form.valid()==true) && (currentIndex ==1)){
                        saveData();
                }else if ((form.valid()==true) && (currentIndex ==0)){
                        saveData();                    
                }else{
