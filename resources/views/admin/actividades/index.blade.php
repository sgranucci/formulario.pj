...
<div class="card">
    ...
    <form class="wizard-form steps-basic" action="#" data-fouc>
        <h6>Sea usted bienvenido/a a Sailing</h6>
        <fieldset>
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Select location:</label>
                        <select name="location" data-placeholder="Select position" class="form-control " data-fouc>
                            <option></option>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="position" data-placeholder="Select position" class="form-control " data-fouc>
                            <option></option>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <select name="birth-month" data-placeholder="Month" class="form-control " data-fouc>
                                    <option></option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <select name="birth-day" data-placeholder="Day" class="form-control " data-fouc>
                                    <option></option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <select name="birth-year" data-placeholder="Year" class="form-control " data-fouc>
                                    <option></option>
        ...
        <fieldset>
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Country:</label>
                        <select name="university-country" data-placeholder="Choose a Country..." class="form-control " data-fouc>
                            <option></option>
                            <option value="1">United States</option>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <select name="education-from-month" data-placeholder="Month" class="form-control " data-fouc>
                                            <option></option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <select name="education-from-year" data-placeholder="Year" class="form-control " data-fouc>
                                            <option></option>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <select name="education-to-month" data-placeholder="Month" class="form-control " data-fouc>
                                            <option></option>
                                            <option value="January">January</option>
                                            <option value="...">...</option>
                                            <option value="December">December</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <select name="education-to-year" data-placeholder="Year" class="form-control " data-fouc>
                                            <option></option>
                                            <option value="1995">1995</option>
                                            <option value="...">...</option>
                                            <option value="1980">1980</option>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="source" data-placeholder="Choose an option..." class="form-control " data-fouc>
                            <option></option>
