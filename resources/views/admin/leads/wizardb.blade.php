            ...
            <div class="col-md-12">
                ...
                <!--<form id="form" class="wizard-form steps-validation wizard" action="{{route('formulario.create')}}" data-fouc method="post" enctype="multipart/form-data">-->
                    ...
                    @endif
                     ...
                     @include('admin.leads.forms.form1b')
